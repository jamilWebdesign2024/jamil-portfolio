...
const Banner = () => {
  ...
  return (
    <section
      id="banner"
      className="relative min-h-[90vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20 bg-base-300 text-base-content pt-28"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16 xl:gap-24">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-lg sm:text-xl max-w-2xl mx-auto lg:mx-0 mb-8 leading-relaxed">
              MERN Stack Developer with 1+ years of experience building scalable
              web applications. I specialize in creating efficient, responsive,
